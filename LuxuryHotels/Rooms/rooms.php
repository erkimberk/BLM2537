...
<body>
    <section class="rooms-page-header">
        <header>
            <div class="logo">
                <span>LUXURY</span>
                <span>HOTELS</span>
            ...
            <nav>
                <ul class="header-nav">
                    ...
                    <li class="active-tab"><a href="../Rooms/rooms.php">Odalar</a></li>
        ...
        <div class="hotel-name">
            <span>LUXURY</span>
            <span>HOTELS</span>
            <span class="rooms-page-hotel-text">Rezervasyonunuzu yaptırın ve en uygun fiyatlarla lüksün keyfini çıkarın.</span>
        </div>
    ...
    <div class="body">
        <section class="rooms-content" id="body">
            <div class="intro-text-div">
                <div class="intro-text-header">
                    ODALAR VE FİYATLAR
                </div>
                <div class="intro-text">
                    Her biri aydınlık ve ışık dolu olan odalarımız, konforlu bir konaklama için ihtiyaç duyabileceğiniz her şeyi sunmaktadır. 
                    Evet, konfor bizim tek hedefimiz değil; aynı zamanda iyi tasarıma da önem veriyoruz. 
                    Modern, şık mobilyalarımız, odalarımızın deniz manzaralı pencerelerinden 
                    ve teraslarından görünen doğanın zengin tonlarıyla tamamlanmaktadır.
                </div>
            </div>
        </section>

        <div class="rooms">
            <div class="room tekli">
                <img src="../assets/images/Group64.jpg" alt="tekli oda">
                <div class="button-container"><button class="button">₺5048  Ort/gece</button></div>
            </div>
            <div class="room ciftkisilik">
                <img src="../assets/images/Group67.jpg" alt="çift kişilik oda">
                <div class="button-container"><button class="button">₺5323  Ort/gece</button></div>
            </div>
            <div class="room ikiz">
                <img src="../assets/images/Group68.jpg" alt="ikiz oda">
                <div class="button-container"><button class="button">₺5323  Ort/gece</button></div>
            </div>
        </div>
        ...
        <footer class="footer">
            ...
            <div class="columns-wrapper">
                <div class="footer-column footer-column-2">
                    <ul>
                        <li><a href="../Home/Home.html">Hakkımızda</a></li>
                        <li><a href="../ContactUs/contact.html">İletişim</a></li>
