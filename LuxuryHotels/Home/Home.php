...
<body>
    <section class="home-page-header" >
        <header>
            ...
            <nav>
                <ul class="header-nav">
                    <li class="active-tab"><a href="../Home/Home.php">Anasayfa</a></li>
        ...
        <div class="hotel-name">
            <span>LUXURY</span>
            <span>HOTELS</span>
            <span class="home-page-hotel-text">Rezervasyonunuzu yaptırın ve en uygun fiyatlarla lüksün keyfini çıkarın.</span>
        </div>
    ...
    <section class="home-page-showcase" id="body">
        <div class="showcase-text">
            Tüm oda tiplerimiz ücretsiz kahvaltı içermektedir.
        </div>
        <div class="cards">
            <div class="card">
                <div class="card-text">
                    ...
                    <div class="card-text-content">
                        Odalarımız, sizi dinlenme için tasarlanmış 
                        bir ortama taşıyacak şekilde dizayn edilmiştir. 
                        Günlük hayatın stresinden uzaklaşın ve kendinize 
                        özel bir cennet bulun.
                    </div>
                    <div class="card-text-button">
                        <a href="../Facilities/Facilities.php#body"><button class="button">KEŞFET</button></a>
                    </div>
                </div>
                <div class="card-image">
                    <img src="../assets/images/2.jpeg" alt="Room image">
            ...
            <div class="card">
                <div class="card-text">
                    <div class="card-text-header">
                        Kendinizi Kumlara Bırakın
                    </div>
                    <div class="card-text-content">
                        "Sahilde yaşamayı seviyoruz. Kumsala 
                        erişimle denize yakın olmak, huzurlu bir ruh hali
                        sağlıyor. Denizi izlerken zaman adeta duruyor 
                        gibi görünüyor.
                    </div>
                    <div class="card-text-button">
                        <a href="../Facilities/Facilities.php#body"><button class="button">KEŞFET</button></a>
                ...
                <div class="card-image">
                    <img id="thirdImage" src="../assets/images/3.jpg" alt="Room image">
                    <div class="overlay"></div>
                </div>
            </div>
        </div>
